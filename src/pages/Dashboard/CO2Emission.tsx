    ...
    <div style={{ position: 'relative', bottom: '2.5em', display: 'flex', width: '100%', justifyContent: 'center' }}>
      ...
      <Card style={{ width: '184px', margin: '10px', height: '75px', padding: 10, fontSize: '12px', display: 'flex' }}>
        ...
        <div style={{ display: 'grid', textAlign: 'left', marginLeft: '10px' }}>
          CO2 Emissions
          <strong style={{ fontSize: '16px' }}>{data !== undefined ? data.co2_emissions.value.toFixed(2) : 0} {data !== undefined ? data.co2_emissions.unit : '-'}</strong>
        </div>
      ...
      <Card style={{ width: '184px', margin: '10px', height: '75px', padding: 10, fontSize: '12px', display: 'flex' }}>
        ...
        <div style={{ display: 'grid', textAlign: 'left', marginLeft: '10px' }}>
          Trees to Absorb CO2
          <strong style={{ fontSize: '16px' }}>{data !== undefined ? data.trees_to_absorb_co2.value.toFixed(2) : 0} {data !== undefined ? data.trees_to_absorb_co2.unit : '-'}</strong>
        </div>
      </Card>
      ...
      <Card style={{ width: '184px', margin: '10px', height: '75px', padding: 10, fontSize: '12px', display: 'flex' }}>
        ...
        <div style={{ display: 'grid', textAlign: 'left', marginLeft: '10px' }}>
          Annual Car Use
          <strong style={{ fontSize: '16px' }}>{data !== undefined ? data.annual_car_use.value.toFixed(2) : 0} {data !== undefined ? data.annual_car_use.unit : '-'}</strong>
        </div>
      </Card>
    </div >
  )
