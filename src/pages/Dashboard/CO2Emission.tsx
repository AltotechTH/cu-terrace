...
const CO2Emission = ({ dashboardData }: CO2Type['co2']) => {
  ...
  return (
    ...
    <div style={{ position: 'absolute', bottom: '2.5em', display: 'block', width: '100%', textAlign: 'left' }}>
      ...
      <div style={{ display: 'flex' }}>
        <Card style={{ margin: '10px', height: '75px', padding: 10, fontSize: '12px', display: 'flex' }}>
